...
public class NTCreateAccount {
	...
	public static void main(String[] args) {
		...
		WebElement Cur = driver.findElement(By.id("currencyUomId"));
		Select cdd = new Select(Cur);
		cdd.selectByValue("INR");
		...
		WebElement e = driver.findElement(By.className("errorMessageHeader"));
		System.out.println(e.getText());
		
		WebElement e1 = driver.findElement(By.className("errorMessage"));
